...
public class IDCardMsg {
	...
	private boolean isNoEndDate = false;	// 是否长期有效
	...
	void setPortrait(Bitmap portrait) {
...
//	}
	...
	public String toString() {
		return "IDCardMsg [name=" + name + ", sex=" + sex + ", nation="
				+ nation + ", birthDate=" + birthDate + ", address=" + address
				+ "]";
	}

	/**
	 * @param isNoEndDate the isNoEndDate to set
	 */
	public void setNoEndDate(boolean isNoEndDate) {
		this.isNoEndDate = isNoEndDate;
	}

	/** Nation table */
	public static final String[] NATION_TABLE = { "未知", "汉", "蒙古", "回", "藏", "维吾尔", "苗", "彝", "壮", "布依", "朝鲜", "满", "侗",
			"瑶", "白", "土家", "哈尼", "哈萨克", "傣", "黎", "傈僳", "佤", "畲", "高山", "拉祜", "水", "东乡", "纳西", "景颇", "克尔克孜", "土",
			"达斡尔", "仫佬", "羌", "布朗", "撒拉", "毛南", "仡佬", "锡伯", "阿昌", "普米", "塔吉克", "怒", "乌兹别克", "俄罗斯", "鄂温克", "德昂", "保安",
